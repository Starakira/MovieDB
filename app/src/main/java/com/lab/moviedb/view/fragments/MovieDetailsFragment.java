...
public class MovieDetailsFragment extends Fragment {
    ...
    private TextView lbl_title, lbl_genre, lbl_vote, lbl_average, lbl_synopsis, lbl_popularity, lbl_releasedate, lbl_tagline;
    private String movie_id, genre, vote, tagline, title, average, releaseDate, popularity, synopsis;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        lbl_synopsis = view.findViewById(R.id.lbl_details_overview);
        ...
        public void onChanged(Movies movies) {
            ...
            for (int i = 0; i < movies.getProduction_companies().size(); i++) {
                ...
                if (movies.getProduction_companies().get(i).getLogo_path() == null) {
                    image.setImageDrawable(getResources().getDrawable(R.drawable.no_image, getActivity().getTheme()));
                } else {
